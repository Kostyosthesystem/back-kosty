...
local Converted = {
	...
	["_exec1"] = Instance.new("TextButton");
...
Converted["_TextLabel"].Text = "LOL_USERPC3212.EXE"
...
Converted["_TextBox"].Text = "--welcome paste here code"
Converted["_TextBox"].TextColor3 = Color3.fromRGB(0, 255, 0)
Converted["_TextBox"].TextSize = 30
...
Converted["_TextBox"].Position = UDim2.new(0, 0, 0.107692309, 0)
Converted["_TextBox"].Size = UDim2.new(0, 412, 0, 290)
...
Converted["_execute"].Style = Enum.ButtonStyle.RobloxButtonDefault
...
Converted["_TextButton"].Text = "polaria"
Converted["_TextButton"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_TextButton"].TextSize = 14
Converted["_TextButton"].Style = Enum.ButtonStyle.RobloxButtonDefault
...
Converted["_exec1"].Font = Enum.Font.SourceSans
Converted["_exec1"].Text = "local execute"
Converted["_exec1"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_exec1"].TextSize = 14
Converted["_exec1"].Style = Enum.ButtonStyle.RobloxButtonDefault
...
Converted["_TextButton1"].Text = "F3X Hub"
Converted["_TextButton1"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_TextButton1"].TextSize = 14
Converted["_TextButton1"].Style = Enum.ButtonStyle.RobloxButtonDefault
...
local function VZBC_fake_script() -- Fake Script: StarterGui.ScreenGui.Frame.TextButton.LocalScript
	...
	local sendTextEvent = ReplicatedStorage:WaitForChild("polaria")
	
	script.Parent.MouseButton1Click:Connect(function()
		local SS = game.Players.LocalPlayer.Name
		sendTextEvent:FireServer(SS)
	end)
...
local function LIEUOL_fake_script() -- Fake Script: StarterGui.ScreenGui.Frame.LocalScript
	...
	local sendButton = script.Parent:WaitForChild("execute")
	local sendTextEvent = ReplicatedStorage:WaitForChild("back-kosty")
	
	sendButton.MouseButton1Click:Connect(function()
		local SS = textBox.Text
		sendTextEvent:FireServer(SS)
	end)
...
local function NAPRYNO_fake_script() -- Fake Script: StarterGui.ScreenGui.Frame.LocalScript
	...
	local textBox = script.Parent:WaitForChild("TextBox")
	local sendButton = script.Parent:WaitForChild("exec1")
	
	sendButton.MouseButton1Click:Connect(function()
		local SS = textBox.Text
		local func, err = loadstring(SS)
		if func then
			func()
		else
			print("OUCH: " .. err)
